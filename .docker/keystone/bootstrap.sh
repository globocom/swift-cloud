...
# Fake Swift object store service
create_project fake_swift
create_user u_fake_swift FAKE_SWIFT_PASS fake_swift
create_role swiftoperator
create_role ResellerAdmin
create_role_assign u_fake_swift swift admin
create_role_assign u_fake_swift swift ResellerAdmin
